            ...
            <div class="col-md-3">
              <div class="form-group">
                ...
                <div class="input-group date">
                  ...
                  <input class="form-control valdation_check" id="datepickers" readonly type="text" name="ord_date" value="{{$purchData->ord_date}}">
                </div>
                <!-- /.input group -->
              </div>
            </div>
               ...
               <div class="table-responsive">
                <table class="table table-bordered" id="purchaseInvoice">
                  ...
                  <tr id="rowid{{$data->item_id}}">
                    ...
                    <td align="center"><input id="qty_{{$data->item_id}}" min="1" data-id="{{$data->item_id}}" type="text" class="form-control text-center no_units" value="{{$data->quantity_received}}" name="item_quantity[]" data-rate="{{$data->unit_price}}"><input type="hidden" name="item_id[]" value="{{$data->item_id}}"></td>
