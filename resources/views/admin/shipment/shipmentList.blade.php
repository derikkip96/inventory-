            ...
            <div class="box-body">
              <table id="shipmentList" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <th width="12%" align="center">{{ trans('message.invoice.action') }}</th>
                </tr>
                </thead>
                <tbody>
                ...
                <tr>
                  ...
                  <td>
                 @if(Helpers::has_permission(Auth::user()->id, 'edit_shipment'))
                    @if($data->status == 0)
                  ...
                  @endif
                  @if(Helpers::has_permission(Auth::user()->id, 'delete_shipment'))
