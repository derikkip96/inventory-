        ...
        <div class="col-md-9">
          <div class="box box-default">
            <div class="box-body">
              <div class="row">
                <div class="col-md-9">
                 <div class="top-bar-title padding-bottom">{{ trans('message.extra_text.payment_methods') }}</div>
                </div> 
                <div class="col-md-3">
                   @if(Helpers::has_permission(Auth::user()->id, 'add_payment_method'))
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                <thead>
                <tr>
                  <th>{{ trans('message.invoice.name') }}</th>
             ...
             @if(Helpers::has_permission(Auth::user()->id, 'delete_payment_method'))
