      ...
      <div class="box">
        <div class="box-body">
          ...
          <div class="col-md-3 col-xs-6 border-right text-center">
              <h3 class="bold">{{ Session::get('currency_symbol').number_format($salesExclTax ,2,'.',',')}}</h3>
              <span class="text-info">{{ trans('message.report.sales_value') }} </span>
          </div>
          <div class="col-md-3 col-xs-6 border-right text-center">
              <h3 class="bold">{{Session::get('currency_symbol').number_format($purchaseInclTax,2,'.',',')}}</h3>
          ...
          <div class="col-md-2 col-xs-6 text-center">
              ...
              @if(($salesExclTax-$purchaseInclTax)<0)
             ...
             @if($searchType=='daily' || $searchType=='custom')
              <table id="salesList" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  ?>
                  {{number_format(($salesAmount-$purchaseAmount)*100/$salesAmount,2)}}
                  @endif
                  </td>
                </tr>
               @endforeach
