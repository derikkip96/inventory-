        ...
        <div class="box-body">
          ...
          <div class="col-md-6 col-sm-4 col-xs-12">
            ...
            <div class="btn-group pull-right">
              <a target="_blank" href="#" title="CSV" class="btn btn-default btn-flat" id="csv">{{ trans('message.extra_text.csv') }}</a>
              <a target="_blank" href="#" title="PDF" class="btn btn-default btn-flat" id="pdf">{{ trans('message.extra_text.pdf') }}</a>
            </div>
          </div>
            ...
            <div class="box-body">
              <table id="itemList" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <th class="text-center">{{ trans('message.report.mac') }}({{Session::get('currency_symbol')}})</th>
                  <th class="text-center">{{ trans('message.report.retail_price') }}({{Session::get('currency_symbol')}})</th>
                  <th class="text-center">{{ trans('message.report.in_value') }}({{Session::get('currency_symbol')}})</th>
                  <th class="text-center">{{ trans('message.report.retail_value') }}({{Session::get('currency_symbol')}})</th>
                  <th class="text-center">{{ trans('message.report.profit_value') }}({{Session::get('currency_symbol')}})</th>
                ...
                <tr>
                  ...
                  <td class="text-center">{{ number_format($mac,2,'.',',') }}</td>
                  <td class="text-center">{{ number_format($item->retail_price,2,'.',',') }}</td>
                  <td class="text-center">{{ number_format(abs($in_value),2,'.',',') }}</td>
                  <td class="text-center">{{ number_format(abs($retail_value),2,'.',',') }}</td>
                  <td class="text-center">{{ number_format(abs($profit_value),2,'.',',') }}</td>
