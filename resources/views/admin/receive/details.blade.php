      ...
      <div class="col-md-8">
          ...
          <div class="box-body">
                <div class="btn-group pull-right">
                  <button title="Email" type="button" class="btn btn-default btn-flat" data-toggle="modal" data-target="#emailReceived">{{ trans('message.extra_text.email') }}</button>
...
<!--Purchase Received Email Modal start-->
    <div id="emailReceived" class="modal fade" role="dialog">
      <div class="modal-dialog">
        <form id="purchase_form" method="POST" action="{{url('receive/email-purchase-info')}}">
        <input type="hidden" value="{{csrf_token()}}" name="_token" id="token">
        <input type="hidden" value="{{ $rewceiveInfo->id }}" name="receive_no">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="form-group">
              ...
              <input type="email" value="{{$rewceiveInfo->email}}" class="form-control" name="email" id="email">
            </div>
            <?php
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                <div class="checkbox">
                  <label><input type="checkbox" name="purchase_pdf" checked><strong>{{sprintf("%04d",$purchData->id)}}</strong></label>
                </div>
            </div>
          </div>
