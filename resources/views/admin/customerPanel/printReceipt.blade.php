...
<body>
 ...
 <div style="width:450px; float:left;height:50px;">
    ...
    <div style="clear:both;"></div>    <div style="width:300px; float:left;">
      <div style="margin-top:20px;">
        <div style="font-size:16px; color:#000000; font-weight:bold;">{{ $companyInfo['company']['company_name'] }}</div>
        <div style="font-size:16px;">{{ $companyInfo['company']['company_street'] }}</div>
        <div style="font-size:16px;">{{ $companyInfo['company']['company_city'] }}, {{ $companyInfo['company']['company_state'] }}</div>
        <div style="font-size:16px;">{{ $companyInfo['company']['company_country_id'] }}, {{ $companyInfo['company']['company_zipCode'] }}</div>
      </div>
    </div>
