              ...
              <form action='{{ url("customer/profile") }}' method="post" class="form-horizontal" enctype="multipart/form-data" id="myform1">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      ...
                      <input type="hidden" value="{{$userData->debtor_no}}" class="form-control"  name="debtor_no">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="email" value="{{$userData->email}}" class="form-control valdation_check" id="em" name="email">
