              ...
              <div class="box-body">
                <div class="row">
                  ...
                  <div class="btn-group pull-right">
                    <a target="_blank" href="{{URL::to('/')}}/customer-panel/payment-pdf/{{$paymentInfo->id}}" title="PDF" class="btn btn-default btn-flat">PDF</a>
                    <a target="_blank" href="{{URL::to('/')}}/customer-panel/payment-print/{{$paymentInfo->id}}" title="Print" class="btn btn-default btn-flat">Print</a>
                  </div>
                </div>
                </div>
              </div>
