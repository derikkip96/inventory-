          ...
          <div class="box-body">
                <div class="row">
                  ...
                  <div class="col-md-2">
                    ...
                    <a target="_blank" href="{{URL::to('/')}}/customer-panel/shipment-pdf/{{$orderInfo->order_no}}/{{$shipment->id}}" title="PDF" class="btn btn-default btn-flat">PDF</a>
                    <a target="_blank" href="{{URL::to('/')}}/customer-panel/shipment-print/{{$orderInfo->order_no}}/{{$shipment->id}}" title="Print" class="btn btn-default btn-flat">Print</a>
                  </div>
