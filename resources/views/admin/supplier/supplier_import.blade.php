        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="box-header with-border">
              <a href="{{ URL::to('supplierdownloadCsv/sample') }}"><button class="btn btn-default btn-flat btn-border-purple"><span class="fa fa-download"> &nbsp;</span>Download Sample</button></a>
            </div>
