      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
                ...
                <ul class="menua">
                  <li>
                    <a href="#" class="lang" id='ar' >
                      <img src="{{url('/img/flags/ar.png')}}" class="img"> Arabic
                    </a>
                  </li>
                  <li>
                    <a href="#" class="lang" id='ch' >
                      <img src="{{url('/img/flags/ch.png')}}" class="img"> Chinese
                    </a>
                  </li>
                  <li>
                  ...
                  <li>
                    <a href="#" class="lang" id='fr' >
                      <img src="{{url('/img/flags/fr.png')}}" class="img"> French
                    </a>
                  </li>

                  <li>
                    <a href="#" class="lang" id='po' >
                      <img src="{{url('/img/flags/po.png')}}" class="img"> Portuguese
                    </a>
                  </li>
                  <li>
                    <a href="#" class="lang" id='rs' >
                      <img src="{{url('/img/flags/rs.png')}}" class="img"> Russian
                    </a>
                  </li>
                  <li>
                    <a href="#" class="lang" id='sp' >
                      <img src="{{url('/img/flags/sp.png')}}" class="img"> Spanish
                    </a>
                  </li>

                  <li>
                    <a href="#" class="lang" id='tu' >
                      <img src="{{url('/img/flags/tu.png')}}" class="img"> Turkish
                    </a>
                  </li>
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
            @if(!empty($v))
              <img src='{{url("/uploads/userPic/$v")}}' class="user-image" alt="User Image">
            @else
              <img src='{{url("/uploads/userPic/avatar.jpg")}}' class="user-image" alt="User Image">
            @endif 
            ...
            <ul class="dropdown-menu">
              ...
              @if(!empty($v))
                <img src='{{url("/uploads/userPic/$v")}}' class="img-circle" alt="User Image">
            @else
                <img src='{{url("/uploads/userPic/avatar.jpg")}}' class="img-circle" alt="User Image">
            @endif 
                <p>
                  {{ Session::get('name') }}
