...
class EmailTempDetailsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        /*     7*/
        $emailTemp[48]['temp_id'] = 7;
        $emailTemp[48]['subject'] = 'Item Received #{receive_no} of your purchase order #{reference}.';
        $emailTemp[48]['body']    = '<p>Hi {supplier_name},</p><p>Thank you for received item. Here’s a brief overview of your received: Received no #{receive_no}. Purchase order no #{reference}</p><p>If you have any questions, please feel free to reply to this email. </p><p><b>Billing address</b></p><p>&nbsp;{billing_street}</p><p>&nbsp;{billing_city}</p><p>&nbsp;{billing_state}</p><p>&nbsp;{billing_zip_code}</p><p>&nbsp;{billing_country}<br></p><p><br></p><p><b>Received summary<br></b></p><p><b></b>{received_summery}<br></p><p>Regards,</p><p>{company_name}<br></p><br><br>';
        $emailTemp[48]['lang'] = 'en';
        $emailTemp[48]['lang_id'] = 1;

        $emailTemp[49]['temp_id'] = 7;
        $emailTemp[49]['subject'] = 'Subject';
        $emailTemp[49]['body'] = 'Body';
        $emailTemp[49]['lang'] = 'ar';
        $emailTemp[49]['lang_id'] = 2;

        $emailTemp[50]['temp_id'] = 7;
        $emailTemp[50]['subject'] = 'Subject';
        $emailTemp[50]['body'] = 'Body';
        $emailTemp[50]['lang'] = 'ch';
        $emailTemp[50]['lang_id'] = 3;

        $emailTemp[51]['temp_id'] = 7;
        $emailTemp[51]['subject'] = 'Subject';
        $emailTemp[51]['body'] = 'Body';
        $emailTemp[51]['lang'] = 'fr';
        $emailTemp[51]['lang_id'] = 4;

        $emailTemp[52]['temp_id'] = 7;
        $emailTemp[52]['subject'] = 'Subject';
        $emailTemp[52]['body'] = 'Body';
        $emailTemp[52]['lang'] = 'po';
        $emailTemp[52]['lang_id'] = 5;

        $emailTemp[53]['temp_id'] = 7;
        $emailTemp[53]['subject'] = 'Subject';
        $emailTemp[53]['body'] = 'Body';
        $emailTemp[53]['lang'] = 'rs';
        $emailTemp[53]['lang_id'] = 6;

        $emailTemp[54]['temp_id'] = 7;
        $emailTemp[54]['subject'] = 'Subject';
        $emailTemp[54]['body'] = 'Body';
        $emailTemp[54]['lang'] = 'sp';
        $emailTemp[54]['lang_id'] = 7;

        $emailTemp[55]['temp_id'] = 7;
        $emailTemp[55]['subject'] = 'Subject';
        $emailTemp[55]['body'] = 'Body';
        $emailTemp[55]['lang'] = 'tu';
        $emailTemp[55]['lang_id'] = 8;

        DB::table('email_temp_details')->truncate();
