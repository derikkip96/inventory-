...
class PreferenceTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $pre[19]['category'] = 'company';
        $pre[19]['field'] = 'logo';
        $pre[19]['value'] = 'logo.png';


        $pre[20]['category'] = 'company';
        $pre[20]['field'] = 'vat_no';
        $pre[20]['value'] = 'DE9999';

        DB::table('preference')->truncate();
