...
{
	public function __construct(Orders $orders,Sales $sales,Shipment $shipment,Admin $admin) {
    ...
    public function updateProfile(Request $request)
    {
        $this->validate($request, [
            ...
            'email'                 => "required|email|unique:debtors_master,email,$request->debtor_no,debtor_no"
        ]);
    ...
    **/
    ...
    public function viewOrderDetails($orderNo){
        ...
        $data['settings'] = $array_data;

        $data['currency'] = DB::table('currency')->where('id',$data['settings']['company']['dflt_currency_id'])->first();                        
    ...
    */
    ...
    public function viewReceipt($id){
     ...
     public function createReceiptPdf($id){        
        ...
        $pdf = PDF::loadView('admin.customerPanel.paymentReceiptPdf', $data);
       $pdf->setPaper(array(0,0,750,1060), 'portrait');
    ...
    public function printReceipt($id){        
        ...
        $data['companyInfo'] = $array_data;
        $pdf = PDF::loadView('admin.customerPanel.printReceipt', $data);
        $pdf->setPaper(array(0,0,750,1060), 'portrait');
    ...
    */
    ...
    public function shipmentPdf($orderNo,$shipmentId){
      ...
      $pdf = PDF::loadView('admin.customerPanel.shipmentPdf', $data);
      $pdf->setPaper(array(0,0,750,1060), 'portrait');
    ...
    public function shipmentPrint($orderNo,$shipmentId){
      ...
      $data['companyInfo'] = $array_data;
      $pdf = PDF::loadView('admin.customerPanel.shipmentPrint', $data);
      $pdf->setPaper(array(0,0,750,1060), 'portrait');
